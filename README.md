[![R-CMD-check](https://github.com/KWB-R/kwb.monitoring/workflows/R-CMD-check/badge.svg)](https://github.com/KWB-R/kwb.monitoring/actions?query=workflow%3AR-CMD-check)
